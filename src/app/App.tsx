...
const dateCards = [
  ...
  },
  {
    ...
    description: "Let's go for Round 2 but this time without training wheels. i booked us just a timeslot to work there!",
  ...
  
  {
    ...
    time: "16:30",
    title: "Golfclub",
    description: "Show off your golf skills and enjoy the beautiful scenery at the golf club",
    image: "https://mein.toubiz.de/api/v1/media/e524f0a1-c3f2-41a8-82a1-832f90158af5/view",
  ...
  },
  {
    ...
    description: "I have a little surprise planned for us to end the night. I can't wait to see your reaction! Hint: It's both hot and spicy! And it may involve Rope;)",
    image: "https://www.hunkemoller.com/dw/image/v2/BCHL_PRD/on/demandware.static/-/Sites-hkm-master/default/dwed70f553/images/large/150128_7.jpg?sw=453&q=100",
  ...
  },
  {
    ...
    id: 10,
    time: "19:00",
    title: "Making Sushi and playing BattleShip with said Sushi at Home",
    description: "A Fun sushi making session at home with a twist. We will make our own sushi and then play battleship with it. If you lose you have to eat a piece of sushi, if you win i eat a piece of sushi. Let's see who has the best aim and the best taste buds!",
    image: "https://assets.tmecosys.com/image/upload/t_web_rdp_recipe_584x480_1_5x/img/recipe/ras/Assets/64EF898D-2EDD-4B47-A456-E6A7D137AC91/Derivates/00f76cac-64f6-4573-be4f-e604a7d99143.jpg",
...
export default function App() {
    ...
    if (raw) {
      try {
        ...
        if (Array.isArray(parsed)) {
          const nums = parsed.map((v: any) => Number(v)).filter(Number.isFinite);
  ...
  useEffect(() => {
    try {
      setCookie(COOKIE_NAME, JSON.stringify(Array.from(unlockedCards)));
    } catch (e) {
      // ignore write errors
    }
  }, [unlockedCards]);
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-100 via-rose-100 to-red-100 py-12 sm:py-20 px-4">
        <div className={`max-w-4xl sm:max-w-6xl mx-auto transition-all duration-500 px-4 sm:px-0 ${showIntro ? 'blur-sm' : 'blur-0'}`}>
          {/* Header */}
          <motion.div
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-500 flex items-center justify-center gap-2">
              Win each game to unlock the next part of our weekend
          ...
          <div className="space-y-8 sm:space-y-12 pb-12 sm:pb-20">
            {days.map((day) => {
              const cardsForDay = dateCards.filter((c) => c.day === day);
              return (
                <div key={day} className="pt-4">
                 <div className="flex items-center justify-center mb-16">
                  <div className="flex-1 h-px bg-rose-200" />
                  
                  <span className="px-6 py-2 mx-4 rounded-full bg-white border border-rose-300 shadow-md 
                  ...
                  <div className="relative space-y-12 sm:space-y-16 pb-8">
                    <TimelineLine totalCards={cardsForDay.length} />
